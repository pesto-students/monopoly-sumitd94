  ...
  return (
    <div className="player-details">
      {gameState.player1.playing ? (
        <div className="player-1" style={{ borderBottom: gameState.player1.turn ? '3px solid red' : '1px solid #ccc' }}>
      ...
      {gameState.player2.playing ? (
        <div className="player-2" style={{ borderBottom: gameState.player2.turn ? '3px solid yellow' : '1px solid #ccc' }}>
          <div className="player-game__details">
      ...
      {gameState.player3.playing ? (
        <div className="player-3" style={{ borderBottom: gameState.player3.turn ? '3px solid black' : '1px solid #ccc' }}>
          <div className="player-game__details">
      ...
      {gameState.player4.playing ? (
        <div className="player-4" style={{ borderBottom: gameState.player4.turn ? '3px solid green' : '1px solid #ccc' }}>
          <div className="player-game__details">
